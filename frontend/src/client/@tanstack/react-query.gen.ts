...
import { type Options, v1DeleteFmuDirectorySession, v1GetCwdFmuDirectorySession, v1GetFmuDirectorySession, v1InitFmuDirectorySession, v1GetFmuDirectoryConfig, v1V1HealthCheck, appHealthCheck } from '../sdk.gen';
import { type UseMutationOptions, queryOptions } from '@tanstack/react-query';
import type { V1DeleteFmuDirectorySessionData, V1DeleteFmuDirectorySessionError, V1DeleteFmuDirectorySessionResponse, V1GetCwdFmuDirectorySessionData, V1GetFmuDirectorySessionData, V1GetFmuDirectorySessionError, V1GetFmuDirectorySessionResponse, V1InitFmuDirectorySessionData, V1InitFmuDirectorySessionError, V1InitFmuDirectorySessionResponse, V1GetFmuDirectoryConfigData, V1V1HealthCheckData, AppHealthCheckData } from '../types.gen';
import type { AxiosError } from 'axios';
import { client as _heyApiClient } from '../client.gen';

export const v1DeleteFmuDirectorySessionMutation = (options?: Partial<Options<V1DeleteFmuDirectorySessionData>>): UseMutationOptions<V1DeleteFmuDirectorySessionResponse, AxiosError<V1DeleteFmuDirectorySessionError>, Options<V1DeleteFmuDirectorySessionData>> => {
    const mutationOptions: UseMutationOptions<V1DeleteFmuDirectorySessionResponse, AxiosError<V1DeleteFmuDirectorySessionError>, Options<V1DeleteFmuDirectorySessionData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await v1DeleteFmuDirectorySession({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const v1GetCwdFmuDirectorySessionQueryKey = (options?: Options<V1GetCwdFmuDirectorySessionData>) => createQueryKey('v1GetCwdFmuDirectorySession', options);

export const v1GetCwdFmuDirectorySessionOptions = (options?: Options<V1GetCwdFmuDirectorySessionData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await v1GetCwdFmuDirectorySession({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: v1GetCwdFmuDirectorySessionQueryKey(options)
    });
};
...
export const v1GetFmuDirectorySessionMutation = (options?: Partial<Options<V1GetFmuDirectorySessionData>>): UseMutationOptions<V1GetFmuDirectorySessionResponse, AxiosError<V1GetFmuDirectorySessionError>, Options<V1GetFmuDirectorySessionData>> => {
...
export const v1InitFmuDirectorySessionMutation = (options?: Partial<Options<V1InitFmuDirectorySessionData>>): UseMutationOptions<V1InitFmuDirectorySessionResponse, AxiosError<V1InitFmuDirectorySessionError>, Options<V1InitFmuDirectorySessionData>> => {
